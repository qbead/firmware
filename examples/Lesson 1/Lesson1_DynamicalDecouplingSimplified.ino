/// # Experiment 2 - Simplified Dynamical Decoupling
///
...
double omega = 0.1;//0.005;//0.003;
// The angle increments to round the orientation of the vertical magnetic field axis to, for Simplified experiment
const int angleIncrement = 90;
...
void loop() {
  ...
  axisVertical = angleRound(bead.angle_acc, angleIncrement);
